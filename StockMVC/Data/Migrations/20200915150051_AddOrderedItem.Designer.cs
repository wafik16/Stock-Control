...
namespace StockMVC.Data.Migrations
{
    ...
    [Migration("20200915150051_AddOrderedItem")]
    partial class AddOrderedItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockMVC.ViewModel.SalesViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("OrderedItemOrderId");

                    b.Property<int?>("OrderedItemProductId");
                    ...
                    b.HasIndex("OrderedItemOrderId", "OrderedItemProductId");
            ...
            modelBuilder.Entity("StockMVC.Models.Order", b =>
                {
                    ...
                    b.HasOne("StockMVC.Models.staff", "Staff")
                        .WithMany("orders")
            ...
            modelBuilder.Entity("StockMVC.ViewModel.SalesViewModel", b =>
                {
                    ...
                    b.HasOne("StockMVC.Models.ProductCategory", "ProductCategory")
                        .WithMany()
                    ...
                    b.HasOne("StockMVC.Models.OrderedItem", "OrderedItem")
                        .WithMany()
                        .HasForeignKey("OrderedItemOrderId", "OrderedItemProductId");
                });
